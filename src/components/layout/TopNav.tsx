...
export function TopNav() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-6 z-50 flex justify-center">
      <nav
        className="pointer-events-auto -ml-10 flex items-center gap-1 rounded-full border border-[var(--color-border)] bg-[var(--color-bg)]/90 p-1.5 shadow-[var(--shadow-md)] backdrop-blur"
