    ...
    >
      {THEMES.map((value) => (
        <button
          ...
          className={
            "flex h-10 w-10 items-center justify-center rounded-full transition-[background-color,color,transform] duration-[var(--dur-fast)] ease-[var(--ease-out)] active:scale-[0.97] " +
            (value === theme
