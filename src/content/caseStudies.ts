...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    pitch: {
      id: "Menghubungkan sales, desain, dan produksi melalui penjadwalan berbasis spesifikasi desain serta kapasitas mesin.",
      en: "Connecting sales, design, and production through scheduling based on design specifications and machine capacity.",
    },
    inANutshell: {
      id: "PT Thursina Mediana Utama, perusahaan penerbitan dan percetakan, sebelumnya mengelola jadwal produksi secara manual. Ketika beberapa order produksi menumpuk, supervisor kesulitan menentukan pekerjaan yang harus diprioritaskan karena belum ada estimasi waktu produksi dan kriteria penjadwalan yang jelas.\n\nKondisi ini dapat menyebabkan keterlambatan produksi dan pada akhirnya memengaruhi kepuasan klien. Saya merancang sistem penjadwalan produksi yang membantu supervisor memperkirakan setiap order dan menentukan prioritas berdasarkan deadline serta estimasi penyelesaian produksi. Tujuannya adalah membuat proses scheduling lebih terstruktur dan membantu supervisor mengambil keputusan prioritas dengan lebih jelas.",
      en: "PT Thursina Mediana Utama, a publishing and printing company, previously managed its production schedules manually. When multiple production orders accumulated, supervisors had difficulty determining which jobs should be prioritized because there were no clear production time estimates or scheduling criteria.\n\nThis often resulted in delayed production, which could ultimately affect client satisfaction. To address this challenge, I designed a production scheduling system that helps production supervisors estimate each production order and prioritize schedules based on deadlines and production completion estimates. The goal was to provide a more structured scheduling process and help supervisors make clearer production priority decisions.",
    },
    snapshot: {
      role: { id: "Full-stack thesis project contributor", en: "Full-stack thesis project contributor" },
      duration: { id: "Feb 2025 — Agu 2025", en: "Feb 2025 — Aug 2025" },
      scope: { id: "Scheduling, capacity planning, cross-team workflow", en: "Scheduling, capacity planning, cross-team workflow" },
      stack: ["PHP", "MySQL", "Tailwind CSS", "Web App"],
      type: { id: "Project skripsi", en: "Thesis project" },
    },
    problem: {
      id: "Tim sales, desain, dan produksi membutuhkan jadwal bersama. Perkiraan waktu produksi sebelumnya bergantung pada tebakan manual, padahal spesifikasi desain dan kapasitas mesin dapat menjadi input perhitungan.",
      en: "Sales, design, and production teams needed a shared schedule. Production estimates previously relied on manual guesswork, even though design specifications and machine capacity could inform the calculation.",
    },
    informationArchitecture: {
      id: "IA mengikuti alur dari kebutuhan sales ke spesifikasi desain, estimasi kapasitas, dan jadwal produksi. Informasi yang diperlukan untuk keputusan ditempatkan dalam satu konteks pekerjaan.",
      en: "The IA follows the flow from sales needs to design specifications, capacity estimation, and production scheduling. Decision-making information is kept in one work context.",
    },
    uxWriting: [
      {
        context: { id: "Estimasi dan jadwal produksi", en: "Production estimates and schedules" },
        before: { id: "Perkiraan waktu produksi bergantung pada tebakan manual.", en: "Production time estimates depended on manual guesswork." },
        after: { id: "Sistem menjelaskan jadwal melalui spesifikasi desain dan kapasitas mesin.", en: "The system explains schedules through design specifications and machine capacity." },
        reason: { id: "Membuat alasan di balik jadwal lebih mudah ditelusuri lintas tim.", en: "To make the reasoning behind a schedule easier to trace across teams." },
      },
    ],
    decisions: [
      {
        decision: { id: "Menjadikan spesifikasi desain dan kapasitas mesin sebagai input penjadwalan.", en: "Use design specifications and machine capacity as scheduling inputs." },
        alternative: { id: "Mengandalkan estimasi manual dari pengalaman operator.", en: "Rely on manual estimates from operator experience." },
        reason: { id: "Jadwal memiliki dasar yang lebih konsisten dan dapat dijelaskan.", en: "Schedules have a more consistent and explainable basis." },
      },
    ],
    metrics: [
      {
        kind: "supporting",
        label: { id: "Manual guesswork replaced", en: "Manual guesswork replaced" },
        impact: { id: "Workflow penjadwalan menggunakan spesifikasi desain dan kapasitas mesin sebagai dasar estimasi.", en: "The scheduling workflow uses design specifications and machine capacity as estimation inputs." },
        status: "proxy",
        method: { id: "Perbandingan pendekatan yang dijelaskan pada project summary.", en: "Comparison of the approaches described in the project summary." },
      },
    ],
    links: [
    ...
    deepDive: [
      {
        label: { id: "Scheduling logic", en: "Scheduling logic" },
        detail: { id: "Penjadwalan menghubungkan spesifikasi desain dengan kapasitas mesin produksi.", en: "Scheduling connects design specifications with production-machine capacity." },
        status: "available",
        href: "https://github.com/msabilil/penjadwalan-produksi-tmu",
      },
    ],
    impact: { id: "Production Scheduling System mengganti tebakan manual dengan alur penjadwalan yang memakai data spesifikasi dan kapasitas; impact berstatus proxy.", en: "Production Scheduling System replaces manual guesswork with scheduling based on specifications and capacity; impact is proxy evidence." },
    reflection: { id: "Jika dikerjakan kembali, saya akan mengukur deviasi estimasi terhadap durasi produksi aktual dan waktu tunggu antar tim.", en: "If I did it again, I would measure estimate deviation against actual production duration and cross-team wait time." },
    recruiterSummary: {
      problem: { id: "Menghubungkan tim lintas fungsi dan mengurangi ketergantungan pada tebakan jadwal.", en: "Connected cross-functional teams and reduced reliance on schedule guesswork." },
      architecture: [{ id: "Menjadikan spesifikasi desain serta kapasitas mesin sebagai dasar keputusan jadwal.", en: "Used design specifications and machine capacity as scheduling inputs." }],
      impact: { id: "Explainable production scheduling workflow. Impact status: proxy.", en: "Explainable production scheduling workflow. Impact status: proxy." },
    },
  },
];
